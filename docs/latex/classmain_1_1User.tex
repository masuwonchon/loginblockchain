...
\begin{DoxyCode}
51     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_ad8e260b3a15f0c0e77c7df7a68d8fcc7}{\_\_init\_\_}(self, **kwargs):
52         super(User, self).\hyperlink{classmain_1_1User_ad8e260b3a15f0c0e77c7df7a68d8fcc7}{\_\_init\_\_}(**kwargs)
53         \textcolor{keywordflow}{if} self.\hyperlink{classmain_1_1User_a2a7a2d67099632b248ad93661e9733d2}{otp\_secret} \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:
54             \textcolor{comment}{# generate a random secret}
55             self.\hyperlink{classmain_1_1User_a2a7a2d67099632b248ad93661e9733d2}{otp\_secret} = base64.b32encode(os.urandom(10)).decode(\textcolor{stringliteral}{'utf-8'})
56 
\end{DoxyCode}
...
\begin{DoxyCode}
72     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_a8b69af8d948dbe7698c904bf94c6ac21}{get\_totp\_uri}(self):
73         \textcolor{keywordflow}{return} \textcolor{stringliteral}{'otpauth://totp/2FA-Demo:\{0\}?secret=\{1\}&issuer=2FA-Demo'}.format(self.
...
\begin{DoxyCode}
58     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_a0086c67911212cc60a39df0424fff2f8}{password}(self):
59         \textcolor{keywordflow}{raise} AttributeError(\textcolor{stringliteral}{'password is not a readable attribute'})
60 
\end{DoxyCode}
...
\begin{DoxyCode}
62     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_a0086c67911212cc60a39df0424fff2f8}{password}(self, password):
63         self.\hyperlink{classmain_1_1User_a4bd5dd61d9eca670b326c87ec7f79f94}{password\_hash} = generate\_password\_hash(password)
64 
\end{DoxyCode}
...
\begin{DoxyCode}
68     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_a147049a30fbe51d6192d320aa3ea5409}{verify\_loginhashblock}(self, LoginHB):
69         loginhashblock = self.Lhashblock.split(\textcolor{stringliteral}{','})
...
\begin{DoxyCode}
65     \textcolor{keyword}{def }\hyperlink{classmain_1_1User_a8acfe5aa75f7a958346bcb2d156586d9}{verify\_password}(self, password):
66         \textcolor{keywordflow}{return} check\_password\_hash(self.\hyperlink{classmain_1_1User_a4bd5dd61d9eca670b326c87ec7f79f94}{password\_hash}, password)
67 
\end{DoxyCode}
